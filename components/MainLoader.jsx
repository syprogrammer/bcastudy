...
const MainLoader = ({page}) => {
    return (
        <div className="loading absolute left-[25%] md:left-[35%] lg:left-[40%] top-[25%]">
            ...
            <div className="py-5 flex flex-col gap-2 text-center text-xl font-"><span>Loading {page}</span><span> please wait...</span></div>
        </div>
    )
}
